...
echo "   dockserver -p / --preinstall  =   running preinstall parts for dockserver
echo ""
...
"
  ...
  if [[ -f $basefolder/$compose ]];then $(which rm) -rf $basefolder/$compose;fi
  if [[ -f $basefolder/$composeoverwrite ]];then $(which rm) -rf $basefolder/$composeoverwrite;fi

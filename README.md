...
If you currently have a server with PG/MHS/PTS, have a look here before you start the isntallation: [Migration Guide](https://dockserver.io/install/migration.html)

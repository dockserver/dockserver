...
### DONT CHNAGE THIS ABOVE ITS AUTOGENERATED ###
...
PROWLARR4KIMAGE=${PROWLARRIMAGE:-ghcr.io/hotio/prowlarr:nightly}
PROWLARR4KTHEME=${PROWLARRTHEME:-organizr-dark}
PROWLARRHDRIMAGE=${PROWLARRIMAGE:-ghcr.io/hotio/prowlarr:nightly}
PROWLARRHDRTHEME=${PROWLARRTHEME:-organizr-dark}
